    ...
    <form onSubmit={handleSubmit}>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <div className="relative md:col-span-2">
          <div className="grid gap-4 md:grid-cols-2">
            <div>
              <label htmlFor="bus-from" className="label">
                {t('from')}
              </label>
              <input
                id="bus-from"
                ...
                className="input"
                placeholder="City or Bus Station"
              />
            </div>
            ...
            <div>
              <label htmlFor="bus-to" className="label">
                {t('to')}
              </label>
              <input
                id="bus-to"
        ...
        {/* Date */}
        <div>
          <label htmlFor="bus-date" className="label">
            {t('departDate')}
          </label>
          <input id="bus-date" type="date" className="input" />
        </div>

        {/* Passengers */}
        <div>
          <label htmlFor="bus-passengers" className="label">
            {t('passengers')}
          </label>
          <select id="bus-passengers" className="select">
